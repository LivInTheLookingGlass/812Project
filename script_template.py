...
RAND_WORKLOAD_MAX_CLOCK_DRIVE = 1.5  # seconds
RAND_WORKLOAD_CLOCK_DRIFTS = [uniform(-RAND_WORKLOAD_MAX_CLOCK_DRIVE, RAND_WORKLOAD_MAX_CLOCK_DRIVE) for _ in range(RAND_WORKLOAD_NUM_SOCKETS)]  # seconds
